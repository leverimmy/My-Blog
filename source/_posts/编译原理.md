...
![T 型图](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/t-diagram.png)
...
![T 型图的叠加](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/t-diagram-add.png)

> 例：将机器 A 上的语言 L 移植到机器 B。即，我们现在有 L-(A)-A，我们需要构造一个 L-(B)-B。
>
> ![构造](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/t-diagram-ex.png)
>
> 在上图中，红框部分不是必要相邻的。
...
![L-属性文法](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/l-attributed-grammar.png)
...
\end{align*}
$$
![消除基础文法左递归](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/reduce-left-recursion.png)
...
![拉链与代码回填](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/backpatching.png)
...
![静态链](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/static-links.png)
...
![动态链](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/dynamic-links.png)

#### Display 表

采用静态链实现非局部量访问，需要沿静态链进行多次访存操作。另一种方法是采用全局 **Display 表**。Display 表中存储的是**静态链每一层中，最新活动记录的基地址**。

![Display 表](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/display.png)
...
![TAC 对应的 DAG子图](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/tac-dag-subgraph.png)
...
![DAG](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/tac-dag-ex.png)
...
>
> ![无法进行代码外提](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/not-for-hoisting.png)
>
...
![删除归纳变量](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Principles-and-Practice-of-Compiler-Construction/induction-variable-substitution.png)
