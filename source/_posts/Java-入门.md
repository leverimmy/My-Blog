...
![编程语言排名](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Introduction-to-Java/rank.png)
...
![新建一个新的项目](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Introduction-to-Java/create-new-project.png)
...
![编译并运行后的输出界面](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Introduction-to-Java/compile-and-run.png)
...
>
> ![创建带有测试的代码结构](https://github.com/leverimmy/My-Blog/blob/main/source/gallery/Introduction-to-Java/create-with-tests.png)
>
